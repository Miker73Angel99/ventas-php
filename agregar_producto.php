...
<div class="container">
    ...
    <form method="post">
        <div class="mb-3">
            ...
            <input type="text" name="codigo" class="form-control" id="codigo" placeholder="Ingrese el codigo del producto">
        </div>
        <div class="mb-3">
            <label for="nombre" class="form-label">Nombre o descripción</label>
            <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Ejemplo Nucan">
        </div>
        <div class="row">
            <div class="col">
